...
class DefaultApi
{
     ...
     * @return \Swagger\Client\Model\I18nConfig
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\I18nConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiConfigI18nGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\I18nConfig';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\I18nConfig',
    ...
    {
        list($response) = $this->apiConfigTimesheetGetWithHttpInfo();
        return $response;
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiConfigTimesheetGetRequest()
    {
    ...
    {
        list($response) = $this->apiPluginsGetWithHttpInfo();
        return $response;
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiPluginsGetRequest()
    {
