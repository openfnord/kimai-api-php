...
class TimesheetEntity implements ModelInterface, ArrayAccess
{
    ...
    public function setDuration($duration)
    {
        ...
        if (!is_null($duration) && ($duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling TimesheetEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setRate($rate)
    {
        ...
        if (!is_null($rate) && ($rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $rate when calling TimesheetEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setFixedRate($fixed_rate)
    {
        ...
        if (!is_null($fixed_rate) && ($fixed_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $fixed_rate when calling TimesheetEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setHourlyRate($hourly_rate)
    {
        ...
        if (!is_null($hourly_rate) && ($hourly_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $hourly_rate when calling TimesheetEntity., must be bigger than or equal to 0.');
        }
