...
class UserEntity implements ModelInterface, ArrayAccess
{
    ...
    public function setUsername($username)
    {
        if ((mb_strlen($username) > 0)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UserEntity., must be smaller than or equal to 0.');
        }
        if ((mb_strlen($username) < 0)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UserEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        if (!is_null($account_number) && (mb_strlen($account_number) > 0)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling UserEntity., must be smaller than or equal to 0.');
        }
