...
class ActivityEntity implements ModelInterface, ArrayAccess
{
     ...
     * Sets meta_fields
     *
     * @param \Swagger\Client\Model\ActivityMeta[] $meta_fields All visible meta (custom) fields registered with this activity
     *
     * @return $this
     */
     ...
     * Sets teams
     *
     * @param \Swagger\Client\Model\Team[] $teams If no team is assigned, everyone can access the activity
     *
     * @return $this
     */
    ...
    public function setBudget($budget)
    {
        ...
        if (($budget > 900000000000)) {
            throw new \InvalidArgumentException('invalid value for $budget when calling ActivityEntity., must be smaller than or equal to 900000000000.');
        }
        if (($budget < 0)) {
    ...
    public function setTimeBudget($time_budget)
    {
        ...
        if (($time_budget > 2145600000)) {
            throw new \InvalidArgumentException('invalid value for $time_budget when calling ActivityEntity., must be smaller than or equal to 2145600000.');
        }
        if (($time_budget < 0)) {
            throw new \InvalidArgumentException('invalid value for $time_budget when calling ActivityEntity., must be bigger than or equal to 0.');
        }
