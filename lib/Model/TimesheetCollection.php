...
class TimesheetCollection implements ModelInterface, ArrayAccess
{
    ...
    public function setDuration($duration)
    {
        ...
        if (!is_null($duration) && ($duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling TimesheetCollection., must be bigger than or equal to 0.');
        }
    ...
    public function setRate($rate)
    {
        ...
        if (!is_null($rate) && ($rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $rate when calling TimesheetCollection., must be bigger than or equal to 0.');
        }
